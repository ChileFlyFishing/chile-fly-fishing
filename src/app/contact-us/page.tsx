...
export default function ContactUsPage() {
  const [milesAway, setMilesAway] = useState<number>(4960); // Fallback por defecto gringo
    ...
    fetch("http://ip-api.com/json/")
      ...
      .then((data) => {
        if (data.lat && data.lon) {
          const distance = calculateMiles(data.lat, data.lon, COYHAIQUE_LAT, COYHAIQUE_LON);
    ...
    <>
      ...
      <div className="w-full min-h-screen relative bg-[#202020] text-white selection:bg-[#C4944E]/30 antialiased overflow-x-hidden">
        ...
        <main>
          ...
          {/* SECCIÓN 2: Formulario Dividido (Fondo Crema Exclusivo) */}
              ...
              <div className="lg:col-span-7 w-full max-w-[640px] lg:max-w-none mx-auto lg:pt-4">
                <div className="mb-[42px] text-left">
                  ...
                  <p className="font-sans text-xs md:text-sm text-neutral-600 font-light leading-relaxed">
                    You&apos;re <span className="font-bold text-[#C4944E] tracking-wider">{milesAway.toLocaleString()}</span> miles away from fishing in legendary Chilean Patagonia. <span className="text-neutral-400 block mt-0.5">This will never be far away for you.</span>
                  </p>
                </div>
