        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <div className="relative w-[280px] h-[65px] mb-4">
              <Image 
                src="https://chileflyfishingexpeditions.com/logos/logo-chileflyfishing-white.svg" 
            ...
            <div className="flex items-center space-x-5 text-white/60">
              <a href="https://www.instagram.com/chileflyfishing/" target="_blank" rel="noopener noreferrer" className="hover:text-brand-gold transition-colors" title="Instagram">
              ...
              <a href="https://www.tiktok.com/@chileflyfishing" target="_blank" rel="noopener noreferrer" className="hover:text-brand-gold transition-colors" title="TikTok">
              ...
              <a href="https://www.facebook.com/chileflyfishingcl" target="_blank" rel="noopener noreferrer" className="hover:text-brand-gold transition-colors" title="Facebook">
              ...
              <a href="https://www.youtube.com/@chile_flyfishing" target="_blank" rel="noopener noreferrer" className="hover:text-brand-gold transition-colors" title="YouTube">
              ...
              <a href="https://wa.me/56956570365/" target="_blank" rel="noopener noreferrer" className="hover:text-brand-gold transition-colors" title="WhatsApp">
